...
export const SEED_HORSES: SeedHorse[] = [
  ...
  /* Fünfter Durchgang - auf Nutzerwunsch möglichst umfassende Übernahme
     aktueller Vererber, die über frozen-partners.com vermarktet werden.
     Wichtig: Frozen Partners ist ein deutscher Vermarkter für Gefriersamen
     (Sitz Kamp-Lintfort). Das heisst NICHT, dass jeder dort gelistete Hengst
     auch selbst in Europa steht - die meisten der folgenden Hengste stehen
     tatsächlich in den USA (teils bei Oswood Stallion Station, Texas) und
     werden von dort aus mit Gefriersamen nach Europa beliefert. Der Standort
     ist jeweils einzeln recherchiert und im Beschreibungstext vermerkt. */
  {
    name: "Golden Coins",
    yearOfBirth: 2020,
    color: "Bay",
    ...
    disciplines: ["Reining"],
    sireName: "Spooks Gotta Gun",
    damName: "Electric Cha Ching",
    description:
      "NRBC Level 4 Open Champion und NRHA Level 4 Open Derby Reserve Champion 2025 mit über 235.000 US-Dollar Erfolgen. Steht bei Capital Quarter Horses in Pilot Point, Texas - Gefriersamen wird über Frozen Partners auch für Europa angeboten.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    name: "Electric Cha Ching",
    sex: "mare",
    country: "US",
    description: "Mutter von Golden Coins.",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    ...
    disciplines: ["Reining"],
    sireName: "Colonels Smoking Gun",
    damName: "Shesouttayourleague",
    description:
      "NRHA-Allzeit-Rekordverdiener und erster Millionen-Dollar-Reiningpferd, geritten von Casey Deary, mit über 1.050.000 US-Dollar Erfolgen. Steht bei Oswood Stallion Station in Weatherford, Texas - Gefriersamen wird über Frozen Partners auch für Europa angeboten.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    ...
    sex: "mare",
    country: "US",
    sireName: "Walla Walla Whiz",
    description: "Mutter von Down Right Amazing.",
    isHistoric: true,
  },
  {
    name: "Patriot",
    ...
    disciplines: ["Reining"],
    sireName: "Smart Spook",
    damName: "Dunit A Lil Ruf",
    description:
      "2022 Run For A Million Champion und 2019 AQHA World Show Junior Reining Champion mit über 836.000 US-Dollar Erfolgen. Steht bei Brent Loseke Colt Company in Valley View, Texas - Gefriersamen wird über Frozen Partners auch für Europa angeboten.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    name: "Dunit A Lil Ruf",
    sex: "mare",
    country: "US",
    description: "Mutter von Patriot.",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    ...
    color: "Palomino",
    country: "US",
    description: "Vater von Flexing Guns N Town und Shining In Town.",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    ...
    damName: "Shesa Fashion Gun",
    description:
      "NRHA-Erfolgspferd (u. a. NRHA Breeders Futurity Open 3. Platz, NRHA Italian Futurity Open 2. Platz) mit über 614.000 US-Dollar Erfolgen, geritten von Arnaud Girinon. Steht bei Oswood Stallion Station in Weatherford, Texas - Gefriersamen wird über Frozen Partners auch für Europa angeboten.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    name: "Shesa Fashion Gun",
    sex: "mare",
    yearOfBirth: 2014,
    color: "Fuchs",
    country: "US",
    sireName: "Colonels Smoking Gun",
    damName: "Shesa Fashion Chic",
    description: "Mutter von Flexing Guns N Town.",
    isHistoric: true,
  },
  {
    ...
    disciplines: ["Reining"],
    description:
      "Bekannter NRHA-Vererber, Vater von Americasnexttopgun und Grossvater von Down Right Amazing (über die Mutterlinie).",
    bloodlineNote: "Weitere eigene Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    ...
    disciplines: ["Reining"],
    sireName: "Walla Walla Whiz",
    damName: "Americasnextgunmodel",
    description:
      "2022 NRHA Level 4 Open Derby Champion und 2020 NRBC Level 4 Open Derby Champion mit über 425.000 US-Dollar Erfolgen. Steht bei Oswood Stallion Station in Weatherford, Texas - Gefriersamen wird über Frozen Partners auch für Europa angeboten.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    ...
    country: "US",
    sireName: "Colonels Smoking Gun",
    description: "Mutter von Americasnexttopgun, geht über die Mutterlinie auf Mr Gun Smoke zurück.",
    isHistoric: true,
  },
  {
    name: "Modern Gun",
    ...
    country: "US",
    disciplines: ["Reining"],
    sireName: "Gunners Special Nite",
    damName: "Taris Modern Design",
    description:
      "NRHA-Erfolgspferd mit über 362.000 US-Dollar Erfolgen. Steht bei Foals-R-Us in Whitesboro, Texas - Gefriersamen wird über Frozen Partners auch für Europa angeboten.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    ...
    country: "US",
    description: "Vater von Modern Gun.",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    name: "Taris Modern Design",
    sex: "mare",
    country: "US",
    description: "Mutter von Modern Gun.",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    ...
    country: "US",
    disciplines: ["Reining"],
    sireName: "Einsteins Revolution",
    damName: "Snip O Chex",
    description:
      "NRHA-Erfolgspferd mit über 100.000 US-Dollar Erfolgen. Wird über Frozen Partners auch für den europäischen Markt angeboten.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    ...
    country: "US",
    description: "Vater von Snip O Lution.",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    ...
    sex: "mare",
    country: "US",
    description: "Mutter von Snip O Lution.",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    name: "Inferno 66",
    aka: "Inferno Sixty Six",
    country: "US",
    disciplines: ["Reining"],
    sireName: "Gunnatrashya",
    damName: "Snip O Gun",
    description:
      "Reserve Champion der NRHA Futurity 2015 mit über 206.000 US-Dollar Erfolgen. Steht bei Toyon Ranch LLC (Slide Or Die LLC) - Gefriersamen wird über Frozen Partners auch für Europa angeboten.",
    bloodlineNote:
      "Die Mutter wird in Quellen teils als Snip O Gun, teils als Snip O Cash genannt - nicht abschliessend geklärt.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    ...
    country: "US",
    disciplines: ["Reining"],
    description: "NRHA-Millionen-Dollar-Vererber, Vater von Inferno 66.",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    ...
    sex: "mare",
    country: "US",
    description: "Mutter von Inferno 66 (in manchen Quellen als Snip O Cash geführt).",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    ...
    sireName: "HF Mobster",
    description:
      "2019 Congress Open Futurity Champion und 2019 RMRHA Summer Slide Open Futurity Champion mit über 93.000 US-Dollar Erfolgen. Wird über Frozen Partners auch für den europäischen Markt angeboten.",
    bloodlineNote:
      "Mutter und genauer aktueller Standort in den Quellen nicht sicher benannt - bitte ergänzen.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    ...
    country: "US",
    description: "Vater von Customize My Dream.",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    ...
    country: "US",
    disciplines: ["Reining"],
    sireName: "Magnum Chic Dream",
    damName: "Gunna Be Custom",
    description:
      "2022 NRHA Reserve Futurity Open Champion und Teilnehmer am Run For A Million als Vierjähriger. Steht bei Oswood Stallion Station in Weatherford, Texas - Gefriersamen wird über Frozen Partners auch für Europa angeboten.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    name: "Gunna Be Custom",
    sex: "mare",
    country: "US",
    sireName: "Colonels Smoking Gun",
    description: "Mutter von Customize My Dream.",
    isHistoric: true,
  },
  {
    name: "Shine Ann",
    ...
    country: "US",
    sireName: "Shining Spark",
    description: "Mutter von Shining In Town.",
    isHistoric: true,
  },
  {
    name: "Shining In Town",
    yearOfBirth: 2013,
    color: "Palomino, Dun-Faktor",
    country: "CA",
    disciplines: ["Reining"],
    sireName: "Hollywoodstinseltown",
    damName: "Shine Ann",
    description:
      "Von Carol Rose gezüchtet, über 226.000 US-Dollar Erfolge. Steht bei Heule Reining Horses in Abbotsford, British Columbia (Kanada) - Gefriersamen wird über Frozen Partners auch für Europa angeboten.",
    availability: "frozen",
    isHistoric: false,
  },
  {
    ...
    country: "US",
    sireName: "Shining Spark",
    description: "Mutter von Shine N Spook.",
    isHistoric: true,
  },
  {
    name: "Shine N Spook",
    ...
    description:
      "2014 NRHA Futurity Open Level 4 Co-Champion, im Besitz von Ubere Ranch. Wird über Frozen Partners auch für den europäischen Markt angeboten.",
    bloodlineNote: "Aktueller Standort in den Quellen nicht sicher benannt - bitte ergänzen.",
    availability: "frozen",
    isHistoric: false,
  },
  {
  ...
  {
    name: "Conquistador Sis",
    sex: "mare",
    country: "US",
    description: "Mutter von Tinsel Whizington.",
    bloodlineNote: "Weitere Abstammung noch nicht gesichert - bitte ergänzen.",
    isHistoric: true,
  },
  {
    name: "Tinsel Whizington",
    yearOfBirth: 2016,
    color: "Buckskin",
    disciplines: ["Reining"],
    sireName: "Tinsel Jac",
    damName: "Conquistador Sis",
    description:
      "Mehrfacher Futurity-Champion mit rund 50.000 US-Dollar Erfolgen. Wird über Frozen Partners als \"EU-Hengst\" gelistet - ein gesicherter eigener Standort in Europa liess sich in den Quellen aber nicht bestätigen.",
    bloodlineNote:
